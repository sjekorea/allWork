...
public interface HomeCommonService {
	...
	List<Map<String, Object>> selectMainRollBannerList(Map<String, Object> map) throws Exception;
	List<Map<String, Object>> selectMainTopRollBannerList(Map<String, Object> map) throws Exception;
	List<Map<String, Object>> selectMainRecruitList(Map<String, Object> map) throws Exception;	
	List<Map<String, Object>> selectMainPayRecruitList(Map<String, Object> map) throws Exception;	
