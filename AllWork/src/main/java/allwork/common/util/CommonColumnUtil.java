...
public class CommonColumnUtil {
	...
	public static String getRecruitColumn(){
		...
		rtnStr += ", nic.biz_form, nic.biz_form_file, nic.sms_send, nic.biz_page, nic.hit, nic.type_r, nic.order_view, nic.pay_type, getCodeName(nic.pay_type) pay_type_name";
