         ...
         <p>올워크 모든회원의 가입은 <span class="bold">무료</span>입니다.</p>
				...
				<form action="#none" method="post">
					<fieldset>
						<legend>회원가입</legend>
            <div class="tab">
              <span class="btn_persnal"><input id="persnal_register" type="radio" name="persnal_register" onClick="location.href='/personalJoin.do'" /><label for="persnal_register">&nbsp;개인회원</label></span>
              <span class="btn_company"><input id="company_register" type="radio" name="company_register" onClick="location.href='/companyjoin.do'" checked="checked"/><label for="company_register">&nbsp;기업회원</label></span>
            </div>
            <div class="descBox">
                ...
                <tbody>
                  ...
                  <tr class="companyNum">
                    <th>사업자번호<span class="necessary">*</span></th>
      							<td>
                      <span><input id="year" type="text" name="year"/><label for="year">&nbsp;-</label></span>
                      <span><input id="month" type="text" name="month"/><label for="month">&nbsp;-</label></span>
                      <span><input id="day" type="text" name="day"/><label for="day"></label></span>
                      <span><input type="submit" value="중복확인" title="중복확인"/></span>
                    </td>
      						</tr>
                  <tr>
            ...
            <div class="confirm">
              <ul>
                ...
                <li>
                  <a href="#none" title="아이핀 인증">
                    <p class="icons"><i class="fas fa-lock"></i></i></p>
                    <h4>아이핀 인증</h4>
                    <p>본인 인증 시 제공되는 정보는 인증 이외 용도로 이용 또는 저장되지 않습니다.</p>
                  </a>
                </li>
