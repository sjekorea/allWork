				...
				<form action="#none" method="post">
					<fieldset>
						...
						<div class="descBox">
							...
							<p class="desc">
								<span><i class="far fa-check-circle"></i>입사지원자 이력서 관리</span> <span><i
									class="far fa-check-circle"></i>관심인재 스크랩 및 관리</span> <span><i
									class="far fa-check-circle"></i>지원자 통계정보 제공</span>
							</p>
							<p class="title">
								기업유료회원<br />혜택
							</p>
							<p class="desc">
								...
								<span><i class="far fa-check-circle"></i>채용공고 최대노출, 효과극대화
									혜택</span> <span><i class="far fa-check-circle"></i>맞춤인재 추천</span>
							</p>
						</div>
							...
							<table>
								...
								<tbody>
									...
									<tr class="companyNum">
										...
										<td><span><input id="year" type="text" name="year" /><label
												for="year">&nbsp;-</label></span> <span><input id="month"
												type="text" name="month" /><label for="month">&nbsp;-</label></span>
											<span><input id="day" type="text" name="day" /><label
												for="day"></label></span> <span><input type="submit"
												value="중복확인" title="중복확인" /></span></td>
									</tr>
									<tr>
									...
									<tr class="businessDesc">
										...
										<td><input type="text" /> <span class="comment">예
												: 네트워크 트래픽 관리제품 개발 및 판매</span></td>
									</tr>
									...
									<tr class="address">
										...
										<td>
											<p class="postNumber">
												<input id="postNum01" type="text" name="postNum01"
													title="우편번호01" />-<input id="postNum02" type="text"
													name="postNum02" title="우편번호02" />&nbsp;<input
													type="submit" value="중복확인" title="중복확인" />
											</p>
											<p>
												<input id="address01" type="text" name="address01"
													title="주소01" />
											</p>
											<p>
												<input id="address02" type="text" name="address02"
													title="주소02" />
											</p>
										</td>
									</tr>
							...
							<table>
								...
								<tbody>
									...
									<tr class="birthday">
										...
										<td><span><input id="year" type="text" name="year" /><label
												for="year">&nbsp;년</label></span> <span><input id="month"
												type="text" name="month" /><label for="month">&nbsp;월</label></span>
											<span><input id="day" type="text" name="day" /><label
												for="day">&nbsp;일</label></span></td>
									</tr>
									<tr>
						...
						<div class="confirm">
							<ul>
								<li><a href="#none" title="휴대폰 인증">
										<p class="icons">
											<i class="fas fa-mobile-alt"></i>
										</p>
										<h4>휴대폰 인증</h4>
										<p>본인 인증 시 제공되는 정보는 인증 이외 용도로 이용 또는 저장되지 않습니다.</p>
								</a></li>
								<li><a href="#none" title="아이핀 인증">
										<p class="icons">
