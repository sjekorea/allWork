...
<style type="text/css">
	/*현재메뉴 언더라인*/
	#menuTree ul .subMenu06{text-decoration: underline;}
</style>
...
<div id="containerWrap">
	...
	<div id="rightPart">
		...
		<div id="part02">
			<form id="keyworkSearchForm" name="keyworkSearchForm" method="post" action="/resumeSearchForFree.do" >
				<fieldset>
					<legend>검색</legend>
					<div>
...
<form id="searchForm" name="searchForm" method="post" action="/resumeSearchForFree.do">
