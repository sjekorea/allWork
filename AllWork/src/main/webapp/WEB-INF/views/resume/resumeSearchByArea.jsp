...
<div id="containerWrap">
	...
	<div id="rightPart">
		...
		<div id="part03">
			<div id="row01">
				<ul class="tab">
					<li id="area" style="background-color:#000;"><a href="#" title="">지역</a></li>
...
<form id="searchForm" name="searchForm" method="post" action="/resumeSearchByArea.do">
	...
	<input type="hidden" name="searchKind" id="searchKind" value="area" />
