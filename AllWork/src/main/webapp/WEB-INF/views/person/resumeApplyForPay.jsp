...
<link rel="stylesheet" type="text/css" href="/css/personal_payService.css"/>
...
<div id="rightPart">
<h4>유료옵션 서비스 신청</h4>
<p class="imgArea"><img src="/img/personal_payService/img01.jpg" alt="이미지00"/></p>
<div>
<form>
<fieldset>
<legend>인재검색 페이지 상단 이력서 강조상품</legend>
<p class="refund_btn"><a href="" title="환불정책 보기">환불정책 보기</a></p>
<div class="allPart">
<h5>가격</h5>
<div>
<p>
<span class="day">7일</span><span class="fee">100,000원</span><span class="desc">/ vat포함</span><span><input type="radio" checked="checked"/></span>
</p>
<p>
<span class="day">15일</span><span class="fee">150,000원</span><span class="desc">/ vat포함</span><span><input type="radio"/></span>
</p>
<p>
<span class="day">30일</span><span class="fee">200,000원</span><span class="desc">/ vat포함</span><span><input type="radio"/></span>
</p>
</div>
