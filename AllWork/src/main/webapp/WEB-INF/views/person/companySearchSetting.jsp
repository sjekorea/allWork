					...
					<fieldset>
						...
						<table>
							...
							<tbody>
								...
								<tr>
									<th>성별</th>
									<td><span><input id="reg02_desc13" type="radio"
											name="reg02_desc13" /><label for="reg02_desc13">성별무관</label></span>
										<span><input id="reg02_desc13_1" type="radio"
											name="reg02_desc13_1" /><label for="reg02_desc13_1">남자</label></span>
										<span><input id="reg02_desc13_2" type="radio"
											name="reg02_desc13_2" /><label for="reg02_desc13_2">여자</label></span>
									</td>
								</tr>
								<tr>
									<th>고용형태</th>
								...
								<tr>
									<th>경력사항</th>
									<td><span><input id="reg02_desc09" type="checkbox"
											name="reg02_desc09" /><label for="reg02_desc09">신입</label></span> <span><input
											id="reg02_desc09_1" type="checkbox" name="reg02_desc09_1" /><label
											for="reg02_desc09_1">경력</label></span> <span> <select
											id="reg02_desc09_2" name="reg02_desc09_2" title="경력연차">
									...
									</span> <span><input id="reg02_desc09_3" type="checkbox"
											name="reg02_desc09_3" /><label for="reg02_desc09_3">경력무관</label></span>
									</td>
								</tr>
								<tr>
									<th>급여정도</th>
