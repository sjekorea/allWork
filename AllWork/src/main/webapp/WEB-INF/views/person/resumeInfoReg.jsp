	...
	<div id="container">
		...
		<div id="rightPart">
			<div id="resume00">
				<div id="imgArea">
					<p>
						<img src="img/company_home/img00.jpeg" alt="본인사진" />
					</p>
				</div>
				<div id="detailArea">
					<p class="detail_title">기본정보</p>
					<p class="personal_setting">
						<a href="#none" title="기본정보수정"><i class="fas fa-cog"></i>&nbsp;기본정보수정</a>
					</p>
					<div class="tabelArea">
							...
							<table>
								...
								<tbody>
									<tr>
										...
										<td><span><input id="res01_desc01" type="radio"
												name="res01_desc01" /><label for="res01_desc01">&nbsp;공개</label></span>
											<span><input id="res01_desc01_1" type="radio"
												name="res01_desc01_1" /><label for="res01_desc01_1">&nbsp;비공개</label></span>
										</td>
									</tr>
									<tr>
										<th>이력서 유형<span class="necessary">*</span></th>
										<td><span><input id="res01_desc02" type="radio"
												name="res01_desc02" /><label for="res01_desc02">&nbsp;모두</label></span>
											<span><input id="res01_desc02_1" type="radio"
												name="res01_desc02_1" /><label for="res01_desc02_1">&nbsp;일반</label></span>
											<span><input id="res01_desc02_2" type="radio"
												name="res01_desc02_2" /><label for="res01_desc02_2">&nbsp;아르바이트</label></span>
											<span><input id="res01_desc02_3" type="radio"
												name="res01_desc02_3" /><label for="res01_desc02_3">&nbsp;프리랜서</label></span>
										</td>
									</tr>
								</tbody>
							</table>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td><span><input id="res02_desc01" type="text"
											name="res02_desc01" placeholder="(예 : ASP, SQL, MT 웹프로그래밍)" /></span>
										<span>이력서 제목은 이력서 열람여부를 결정짓는 중요한 부분이므로 희망직무 또는 구체적인
											지원분야를 쓰시는 것이 좋습니다.</span></td>
								</tr>
								<tr>
									<th>현재상태</th>
									<td><span><input id="res02_desc02" type="radio"
											name="res02_desc02" /><label for="res02_desc02">&nbsp;&nbsp;구직희망(미취업)</label></span>
										<span><input id="res02_desc02_1" type="radio"
											name="res02_desc02_1" /><label for="res02_desc02_1">&nbsp;&nbsp;이직희망(재직중)</label></span>
										<span><input id="res02_desc02_2" type="radio"
											name="res02_desc02_2" /><label for="res02_desc02_2">&nbsp;&nbsp;구직희망안함</label></span>
									</td>
								</tr>
								<tr>
									<th>근무지역<span class="necessary">*</span></th>
									<td><select id="reg02_desc05" name="reg02_desc05"
										title="시도선택">
									...
									</select> <select id="reg02_desc05_1" name="reg02_desc05_1"
										title="시구군선택">
									...
									</select> <input id="res02_desc03_3" type="button" name="res02_desc03_3"
										value="+ 추가" /></td>
								</tr>
								<tr>
									<th>직무분야<span class="necessary">*</span></th>
									<td><select id="res02_desc04" name="res02_desc04"
										title="1차직무선택">
									...
									</select> <select id="res02_desc04_1" name="res02_desc04_1"
										title="2차직무선택">
											<option value="2차직무선택">2차직무선택</option>
									</select> <select id="res02_desc04_2" name="res02_desc04_2"
										title="3차직무선택">
											<option value="3차직무선택">3차직무선택</option>
									</select> <input id="res02_desc04_3" type="button" name="res02_desc04_3"
										value="+ 추가" /></td>
								</tr>
								<tr>
									<th>산업분야<span class="necessary">*</span></th>
									<td><select id="res02_desc05" name="res02_desc05"
										title="1차산업선택">
											...
											<option value="영업.판매">영업.판매</option>
											<option value="교육.서비스">교육.서비스</option>
									</select> <select id="res02_desc05_1" name="res02_desc05_1"
										title="2차산업선택">
											<option value="2차산업선택">2차산업선택</option>
									</select> <select id="res02_desc05_2" name="res02_desc05_2"
										title="3차산업선택">
											<option value="3차산업선택">3차산업선택</option>
									</select> <input id="res02_desc05_3" type="button" name="res02_desc05_3"
										value="+ 추가" /></td>
								</tr>
								<tr>
									<th>선택적 직무</th>
									<td><span><input id="res02_desc06" type="radio"
											name="res02_desc06" /><label for="res02_desc06">&nbsp;운전전문직군</label></span>
										<span><input id="res02_desc06_1" type="radio"
											name="res02_desc06_1" /><label for="res02_desc06_1">&nbsp;경비직군</label></span>
										<span><input id="res02_desc06_2" type="radio"
											name="res02_desc06_2" /><label for="res02_desc06_2">&nbsp;일반관리직</label></span>
										<span class="comment">위 직무분야 외 선택적 직무</span></td>
								</tr>
								<tr>
									<th>희망근무형태<span class="necessary">*</span></th>
									<td><span><input id="res02_desc07" type="checkbox"
											name="res02_desc07" /><label for="res02_desc07">정규직</label></span> <span><input
											id="res02_desc07_1" type="checkbox" name="res02_desc07_1" /><label
											for="res02_desc07_1">계약직</label></span> <span><input
											id="res02_desc07_2" type="checkbox" name="res02_desc07_2" /><label
											for="res02_desc07_2">프리랜서</label></span> <span><input
											id="res02_desc07_3" type="checkbox" name="res02_desc07_3" /><label
											for="res02_desc07_3">아르바이트</label></span> <span><input
											id="res02_desc07_4" type="checkbox" name="res02_desc07_4" /><label
											for="res02_desc07_4">추후협의</label></span></td>
								</tr>
								<tr>
									<th>희망연봉<span class="necessary">*</span></th>
									<td><select id="res02_desc08" name="res02_desc08"
										title="연봉/시급선택">
									...
									</select> <select id="res02_desc08_1" name="res02_desc08_1" title="연봉선택">
						...
						<table>
							...
							<tbody>
								<tr class="final_education">
									<th>최종학력</th>
									<td><select id="res03_desc01" name="res03_desc01"
										title="학력 선택">
								...
								<tr class="education">
									<th>학력</th>
									<td><span> <input id="res03_desc02" type="date"
											name="res03_desc02" />
										<!--
-->
											<select id="res03_desc02_1" name="res03_desc02_1"
											title="학교구분">
										...
										<!--
-->
											<input id="res03_desc02_2" type="text" name="res03_desc02_2"
											placeholder="학교명" />
										<!--
-->
											<input id="res03_desc02_3" type="button"
											name="res03_desc02_3" value="삭제" />
									</span> <span> <input id="res03_desc03" type="date"
											name="res03_desc03" />
										<!--
-->
											<select id="res03_desc03_1" name="res03_desc03_1"
											title="졸업상태">
										...
										<!--
-->
											<input id="res03_desc03_2" type="text" name="res03_desc03_2"
											placeholder="학교명" />
										<!--
-->
											<input id="res03_desc03_3" type="text" name="res03_desc03_3"
											placeholder="전공명" />
									</span> <span class="comment"> 다중 경력자는 [추가]를 클릭하면 현재 입력폼에서 추가
											경력을 작성할 수 있습니다.</span></td>
								</tr>
							</tbody>
						</table>
					</fieldset>
						...
						<table>
							...
							<tbody>
								<tr class="total_experience">
									<th>총 경력년수</th>
									<td><select id="res04_desc01" name="res04_desc01"
										title="경력연차">
									...
									</select>&nbsp;년 <select id="res04_desc01_1" name="res04_desc01_1"
										title="경력연차">
											<option value="선택">선택</option>
											<option value="1">1</option>
											<option value="2">2</option>
											...
											<option value="11">11</option>
											<option value="12">12</option>
									</select>&nbsp;개월 <input id="res04_desc01_2" type="checkbox"
										name="res04_desc01_2" /><label for="res04_desc01_2">신입</label>
									</td>
								</tr>
								<tr class="experience">
									<th>경력</th>
									<td><span> <input id="res04_desc02" type="date"
											name="res04_desc02" />
										<!--
-->
											<input id="res04_desc02_1" type="text" name="res04_desc02_1"
											placeholder="회사명" />
										<!--
-->
											<input id="res04_desc02_2" type="button"
											name="res04_desc02_2" value="삭제" />
									</span> <span> <input id="res04_desc03" type="date"
											name="res04_desc03" />
										<!--
-->
											<input id="res04_desc03_1" type="text" name="res04_desc03_1"
											placeholder="담당업무" />
									</span> <span class="comment"> 다중 경력자는 [추가]를 클릭하면 현재 입력폼에서 추가
											경력을 작성할 수 있습니다.</span></td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<p class="part01">
											<span>취득일자</span><br />
											<input id="res06_desc01" type="date" name="res06_desc01"
												value="년/월/일" />
										</p>
										<p class="part02">
											<span>자격증명</span><br /> <select id="res06_desc01_1"
												name="res06_desc01_1" title="자격증1차선택">
											...
											<!--
-->
											<select id="res06_desc01_2" name="res06_desc01_2"
												title="자격증2차선택">
											...
											<!--
-->
											<select id="res06_desc01_3" name="res06_desc01_3"
												title="자격증2차선택">
										...
										<p class="part03">
											<span>발행처</span><br />
											<input id="res06_desc01_4" type="text" name="res06_desc01_4" />
										</p>
										<p class="part04">
											<input id="res06_desc01_5" type="button"
												name="res06_desc01_5" value="삭제" />
										</p>
									</td>
								</tr>
							</tbody>
							...
							<tbody>
								<tr>
									...
									<td>
										<p class="part01">
											<span>취득일자</span><br />
											<input id="res07_desc01" type="date" name="res07_desc01" />
										</p>
										<p class="part02">
											<span>외국어명</span><br />
											<input id="res07_desc01_1" type="text" name="res07_desc01_1" />
										</p>
										<p class="part03">
											<span>수준</span><br /> <select id="res07_desc01_2"
												name="res07_desc01_2" title="선택">
												<option value="선택">선택</option>
										...
										<p class="part04">
											<span>발행처</span><br />
											<input id="res07_desc01_3" type="text" name="res07_desc01_3" />
										</p>
										<p class="part05">
											<span>점수</span><br />
											<input id="res07_desc01_4" type="text" name="res07_desc01_4" />
										</p>
										<p class="part06">
											<span>점수/등급</span><br /> <select id="res07_desc01_5"
												name="res07_desc01_5" title="선택">
												<option value="선택">선택</option>
										...
										<p class="part08">
											<input id="res07_desc01_6" type="button"
												name="res07_desc01_6" value="삭제" />
										</p>
									</td>
								</tr>
							</tbody>
					...
					<fieldset>
						...
						<table>
							...
							<tbody>
								<tr>
									<th>자기소개서</th>
									<td><span><input id="res08_desc01" type="text"
											name="res08_desc01" placeholder="자기소개서 제목" /></span> <textarea
											id="res08_desc01_1"></textarea></td>
								</tr>
							</tbody>
						</table>
					</fieldset>
					...
					<fieldset>
						...
						<table>
							...
							<tbody>
								<tr>
									<th>파일 첨부하기</th>
									<td><span class="file_btn"><input id="res09_desc01" /><label
											for="res09_desc01_1">파일첨부</label><input id="res09_desc01_1"
											type="file" name="res09_desc01" /></span></td>
								</tr>
							</tbody>
						</table>
					</fieldset>
