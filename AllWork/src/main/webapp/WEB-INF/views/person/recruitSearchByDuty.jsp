	...
	<div id="rec_right">
		<div id="recruitment">
			...
			<div id="cateOn">
				...
				<ul class="select02">
					<li><input id="column02_btn011" type="button"
						name="column02_btn011" value="자동차·조선·기계" /></li>
					<li><input id="column02_btn021" type="button"
						name="column02_btn021" value="반도체·디스플레이" /></li>
					<li><input id="column02_btn031" type="button"
						name="column02_btn031" value="화학·에너지·환경" /></li>
					<li><input id="column02_btn041" type="button"
						name="column02_btn041" value="전기·전자·제어" /></li>
					<li><input id="column02_btn051" type="button"
						name="column02_btn051" value="기계설계·CAD·CAM" /></li>
					<li><input id="column02_btn061" type="button"
						name="column02_btn061" value="통신기술·네트워크구축" /></li>
					<li><input id="column02_btn071" type="button"
						name="column02_btn071" value="바이오·제약·식품" /></li>
				</ul>
				<ul class="select03">
					<li><input id="column02_btn012" type="button"
						name="column02_btn012" value="기계" /></li>
					<li><input id="column02_btn022" type="button"
						name="column02_btn022" value="기구설계" /></li>
					<li><input id="column02_btn032" type="button"
						name="column02_btn032" value="생산기술" /></li>
					<li><input id="column02_btn042" type="button"
						name="column02_btn042" value="제품개발" /></li>
					<li><input id="column02_btn052" type="button"
						name="column02_btn052" value="금형설계" /></li>
					<li><input id="column02_btn062" type="button"
						name="column02_btn062" value="R&D" /></li>
					<li><input id="column02_btn072" type="button"
						name="column02_btn072" value="메카트로닉스" /></li>
					<li><input id="column02_btn042" type="button"
						name="column02_btn042" value="금속" /></li>
					<li><input id="column02_btn052" type="button"
						name="column02_btn052" value="조선/플랜트" /></li>
					<li><input id="column02_btn062" type="button"
						name="column02_btn062" value="건설/건축" /></li>
					<li><input id="column02_btn072" type="button"
						name="column02_btn072" value="철강" /></li>
				</ul>
			</div>
		</div>
