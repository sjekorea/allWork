				...
				<p class="footLogo">Allwork</p>
					<div id="copyArea">
						<ul class="menuArea">
							...
							<li><a href="/boardList.do" title="고객센터">고객센터</a></li>
							<li><a href="/privacyPolicy.do" title="개인정보처리방침">개인정보처리방침</a></li>
						...
						<div class="address">
							...
							<span>사업자번호 : 333-86-00277 | 직업정보제공사업등록번호 : 서울청 제2019-2호 | 통신판매업신고번호 : 2020-서울서초-4491호</span><br/>
