...
<div id="containerWrap">
	...
	<c:if test="${SE_USER_TYPE == 'person' }">
		<div id="recruitment">
			...
			<div id="rec_row01">
				<ul class="tab">
					<li style="background-color:#000;"><a href="#" title="직무별">직무별</a></li>
					<li style="background-color:#ddd;"><a href="#" title="산업별"></a></li>
...
<form name="searchForm" id="searchForm" method="post" action="/recruitSearchByDuty.do">
