...
<div id="containerWrap">
	...
	<div id="rightPart">
		<div id="recruitment">
			<h4>알바 채용 정보 상세검색</h4>
			<div id="part02">
				<form id="keyworkSearchForm" name="keyworkSearchForm" method="post" action="/recruitSearchForAlba.do" >
					<fieldset>
						<legend>검색</legend>
						<div>
...
<form name="searchForm" id="searchForm" method="post" action="/recruitSearchForAlba.do">
